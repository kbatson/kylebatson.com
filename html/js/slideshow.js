$('document').ready(function(){
	...
	var resizeSlides = function(){
		...
		console.log('width', $(".slideshow").width());
	...
	$("main").on('click', '.slideControl', function(e){ //Navigate between slides by clicking on slide controls
		console.log('click');
		selectSlide($(this));
		return false;
	});
	
	$(".slide").on('click', function(){ //Navigate between slides by clicking on the slide itself
